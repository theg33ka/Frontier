...
public abstract class SharedExtendedPinpointerSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<ExtendedPinpointerComponent, GotEmaggedEvent>(OnEmagged);
        SubscribeLocalEvent<ExtendedPinpointerComponent, GotUnEmaggedEvent>(OnUnemagged); // Frontier
        SubscribeLocalEvent<ExtendedPinpointerComponent, AfterInteractEvent>(OnAfterInteract);
        SubscribeLocalEvent<ExtendedPinpointerComponent, ExaminedEvent>(OnExamined);
        // Frontier
        SubscribeLocalEvent<ExtendedPinpointerComponent, PinpointerDoAfterEvent>(OnPinpointerDoAfter);
    }

    /// <summary>
    ///     Set the target if capable
    /// </summary>
    private void OnAfterInteract(EntityUid uid, ExtendedPinpointerComponent component, AfterInteractEvent args)
    {
    ...
    private void OnPinpointerDoAfter(EntityUid uid, ExtendedPinpointerComponent component, PinpointerDoAfterEvent args)
    {
        if (args.Cancelled)
            return;
    ...
    /// </summary>
    public virtual void SetTarget(EntityUid uid, EntityUid? target, ExtendedPinpointerComponent? pinpointer = null)
    {
    ...
    /// </summary>
    protected virtual void UpdateDirectionToTarget(EntityUid uid, ExtendedPinpointerComponent? pinpointer = null)
    {

    }

    private void OnExamined(EntityUid uid, ExtendedPinpointerComponent component, ExaminedEvent args)
    {
    ...
    /// </summary>
    public void SetDistance(EntityUid uid, Distance distance, ExtendedPinpointerComponent? pinpointer = null)
    {
        if (!Resolve(uid, ref pinpointer))
            return;
    ...
    /// </summary>
    public bool TrySetArrowAngle(EntityUid uid, Angle arrowAngle, ExtendedPinpointerComponent? pinpointer = null)
    {
        if (!Resolve(uid, ref pinpointer))
            return false;
    ...
    /// </summary>
    public void SetActive(EntityUid uid, bool isActive, ExtendedPinpointerComponent? pinpointer = null)
    {
        if (!Resolve(uid, ref pinpointer))
            return;
    ...
    public virtual bool TogglePinpointer(EntityUid uid, ExtendedPinpointerComponent? pinpointer = null)
    {
        if (!Resolve(uid, ref pinpointer))
            return false;
    ...
    private void OnEmagged(EntityUid uid, ExtendedPinpointerComponent component, ref GotEmaggedEvent args)
    {
    ...
    // Frontier: demag
    private void OnUnemagged(EntityUid uid, ExtendedPinpointerComponent component, ref GotUnEmaggedEvent args)
    {
        if (!_emag.CompareFlag(args.Type, EmagType.Interaction))
            return;
