...
ent-FoodCakeCotton = хлопковый торт
    .desc = Торт с волокнистой глазурью и комком хлопка сверху. Настоящее удовольствие для моли.
ent-FoodCakeCottonSlice = кусок хлопкового торта
    .desc = Кусочек хлопкового торта. Можно просто слизать глазурь — и это уже счастье.
