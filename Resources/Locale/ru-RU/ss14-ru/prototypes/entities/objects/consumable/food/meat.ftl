...
ent-FoodMeatDragonCooked = стейк из дракона
    .desc = Поливать кетчупом считается смертным преступлением на большинстве станций.
ent-FoodMeatDragonCutlet = сырая котлета из дракона
    .desc = Котлета из сырого драконьего мяса.
ent-FoodMeatDragonCutletCooked = котлета из дракона
    .desc = Блюдо для королей!
ent-FoodMeatPatty = мясная котлета
    .desc = Плоский кусок рубленого мяса. Готов к жарке, всегда готов.
ent-FoodMeatPattyCooked = приготовленная котлета
    .desc = Приготовленная мясная котлета. Сочная основа для бургера или тако.
