...
ent-FoodDonkpocketMoth = моль-покет
    .desc = «Жужжащая» версия донк-покета, созданная во время массовых протестов… Хотя кого это волнует? Просто донк-покеты для моли.
ent-FoodDonkpocketMothWarm = тёплый моль-покет
    .desc = Подогретый мот-покет: больше питательности, больше волокон и немного целебного омнизина.
